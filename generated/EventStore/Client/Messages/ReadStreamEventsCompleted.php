...
class ReadStreamEventsCompleted extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \EventStore\Client\Messages\ResolvedIndexedEvent[]|\Google\Protobuf\Internal\RepeatedField $events
     *     @type int $result
    ...
    /**
     * Generated from protobuf field <code>repeated .EventStore.Client.Messages.ResolvedIndexedEvent events = 1;</code>
     * @param \EventStore\Client\Messages\ResolvedIndexedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \EventStore\Client\Messages\ResolvedIndexedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \EventStore\Client\Messages\ReadStreamEventsCompleted_ReadStreamResult::class);
        $this->result = $var;
