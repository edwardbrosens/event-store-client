...
/**
 * Generated from protobuf message <code>EventStore.Client.Messages.ReadAllEventsCompleted</code>
 */
class ReadAllEventsCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.EventStore.Client.Messages.ReadAllEventsCompleted.ReadAllResult result = 6;</code>
     */
    private $result = 0;
    /**
     ...
     *     @type \EventStore\Client\Messages\ResolvedEvent[]|\Google\Protobuf\Internal\RepeatedField $events
    ...
    /**
     * Generated from protobuf field <code>repeated .EventStore.Client.Messages.ResolvedEvent events = 3;</code>
     * @param \EventStore\Client\Messages\ResolvedEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \EventStore\Client\Messages\ResolvedEvent::class);
        $this->events = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \EventStore\Client\Messages\ReadAllEventsCompleted_ReadAllResult::class);
        $this->result = $var;
