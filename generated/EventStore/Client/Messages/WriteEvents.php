...
class WriteEvents extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \EventStore\Client\Messages\NewEvent[]|\Google\Protobuf\Internal\RepeatedField $events
    ...
    /**
     * Generated from protobuf field <code>repeated .EventStore.Client.Messages.NewEvent events = 3;</code>
     * @param \EventStore\Client\Messages\NewEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \EventStore\Client\Messages\NewEvent::class);
        $this->events = $arr;
