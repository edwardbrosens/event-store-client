...
/**
 * Generated from protobuf message <code>EventStore.Client.Messages.PersistentSubscriptionNakEvents</code>
 */
class PersistentSubscriptionNakEvents extends \Google\Protobuf\Internal\Message
{
    ...
    private $message = '';
    /**
     * Generated from protobuf field <code>.EventStore.Client.Messages.PersistentSubscriptionNakEvents.NakAction action = 4;</code>
     */
    private $action = 0;
    ...
    {
        GPBUtil::checkEnum($var, \EventStore\Client\Messages\PersistentSubscriptionNakEvents_NakAction::class);
        $this->action = $var;
