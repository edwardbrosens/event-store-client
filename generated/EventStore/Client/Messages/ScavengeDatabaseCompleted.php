...
/**
 * Generated from protobuf message <code>EventStore.Client.Messages.ScavengeDatabaseCompleted</code>
 */
class ScavengeDatabaseCompleted extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.EventStore.Client.Messages.ScavengeDatabaseCompleted.ScavengeResult result = 1;</code>
     */
    private $result = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \EventStore\Client\Messages\ScavengeDatabaseCompleted_ScavengeResult::class);
        $this->result = $var;
